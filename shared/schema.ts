...
import { scheduleEntries } from "./models/schedule";

// Cross-model relations (jobs <-> schedule)
export const jobsRelations = relations(jobs, ({ many }) => ({
  scheduleEntries: many(scheduleEntries),
}));

// Helper type for job with schedule
export type JobWithSchedule = import("./models/jobs").Job & {
  scheduleEntries: import("./models/schedule").ScheduleEntry[];
};
